...
spark = SparkSession.builder.appName("stedi-all").getOrCreate()
...
# TO-DO: cast the value column in the streaming dataframe as a STRING 
stediDFStream = stediRawDFStream.selectExpr("cast(key as string) key", "cast(value as string) value")
...
stediDFStream.withColumn("value", from_json("value", customerRiskJSONSchema)).select(
